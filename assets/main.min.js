...
var settings=require("modules/settings"),velocity=require("velocity-animate/velocity");module.exports=function(o){function e(){console.log(c),$(".overlay").velocity("stop").velocity({opacity:.8})}function t(){$(".overlay").velocity("stop").velocity({opacity:$(".overlay").data("opacity")})}function i(){}var c=$(o);$window=$(window),c.on("mouseover",e).on("mouseout",t).on("click",i)};
},{"modules/settings":"modules/settings","velocity-animate/velocity":3}],"modules/project-scroll":[function(require,module,exports){
var settings=require("modules/settings"),velocity=require("velocity-animate/velocity"),urlParam=require("modules/urlParam")(),mousewheel=require("jquery-mousewheel"),throttle=require("modules/throttle");module.exports=function(t){function o(){topVal>=0?topVal=0:topVal>=$window.height()?topVal=$window.height():topVal+$window.height()<0?topVal=-$window.height():topVal=topVal,e.css({transform:"translateY("+topVal+"px) rotateZ(0deg)",MozTransform:"translateY("+topVal+"px) rotateZ(0deg)",WebkitTransform:"translateY("+topVal+"px) rotateZ(0deg)",msTransform:"translateY("+topVal+"px) rotateZ(0deg)"}),opacityVal=Math.abs(topVal/$window.height()),$(".overlay").css("opacity",opacityVal).data("opacity",opacityVal),Math.abs(topVal)<=$window.height()/3?$(".overlay").addClass("bottom"):$(".overlay").removeClass("bottom"),topVal+$window.height()<=topNavHeightVal?$("header.over-main").css("height",topVal+$window.height()):$("header.over-main").css("height",topNavHeightVal),topVal+$window.height()<=0?topContainer&&$(".disable-scroll").hide():topContainer&&$(".disable-scroll").show()}var e=$(t);$window=$(window),topVal=0,opacityVal=0,topNavHeightVal=$("header.content").height(),topContainer=!0,$window.on("mousewheel",function(t){return settings.isMobile||!topContainer?!0:(topVal+=t.deltaY,void o())}),$("#section-body").on("scroll",function(){$("#section-body").scrollTop()<=0?topContainer=!0:topContainer=!1})};
...
var settings=require("modules/settings");module.exports=function(o){function t(){s.velocity("stop").velocity({opacity:.5},{duration:settings.animationSpeed})}function e(){s.velocity("stop").velocity({opacity:.5},{duration:settings.animationSpeed})}var i=$(o),n=i.find("article"),s=$(".video");console.log(n),n.on("mouseover",t).on("mouseout",e)};
},{"modules/settings":"modules/settings"}],"modules/section-controller":[function(require,module,exports){
var settings=require("modules/settings"),velocity=require("velocity-animate/velocity"),sectionController=module.exports=function(){this.moveOut=function(t,e){$(t).velocity({top:"-100%"},{duration:settings.animationSpeed,complete:function(){setPath(e)}})},this.moveIn=function(t,e){$(t).velocity({top:0},{duration:settings.animationSpeed,complete:function(){setPath(e)}})},this.toSection=function(t){var e=-1*$(t).index()*100;$("#main").velocity({top:e+"%"},{duration:settings.animationSpeed,complete:function(){}})}};
},{"modules/settings":"modules/settings","velocity-animate/velocity":3}],"modules/settings":[function(require,module,exports){
var settings=module.exports={breakpoints:{xs:481,s:641,m:1e3,ml:999,l:1281,xl:1441,xxl:1921},padding:{top:.04*$(window).height(),left:.03*$(window).width()},animationSpeed:400,isMobile:!1};settings.breakpoints=settings.breakpoints,settings.isMobile=settings.isMobile;
},{}],"modules/throttle":[function(require,module,exports){
module.exports=function(t,e,n){e||(e=250);var o,u;return function(){var a=n||this,i=+new Date,r=arguments;o&&o+e>i?(clearTimeout(u),u=setTimeout(function(){o=i,t.apply(a,r)},e)):(o=i,t.apply(a,r))}};
},{}],"modules/urlParam":[function(require,module,exports){
var urlParam=module.exports=function(){var t="state"in window.history&&null!==window.history.state,n=location.href;$(window).bind("popstate",function(i){var o=!t&&location.href==n;t=!0,o}),this.getPath=function(){return location.pathname},this.setPath=function(t){history.pushState},this.getParam=function(t){},this.setParam=function(t,n){}};
},{}],"modules/video-reel":[function(require,module,exports){
var settings=require("modules/settings"),throttle=require("modules/throttle"),canvid=require("canvid");module.exports=function(t){function e(){$(".project").each(function(){S.push({time:$(this).data("time"),title:$(this).data("title"),url:$(this).data("url")})}),$(x).on("timeupdate",function(t){l(this.currentTime,this.duration)}),b.width()<768?settings.isMobile=!0:settings.isMobile=!1,h(),d(),p.on("mouseover",i).on("mouseout",n).on("click",s),f.on("click",o),M.on("click",s)}function o(){f.toggleClass("on"),f.hasClass("on")?(x.volume=1,y.text("off")):(x.volume=0,y.text("on"))}function i(){w=!1,x.pause()}function n(){w=!0,x.play()}function s(t){t.preventDefault(),$(".overlay").addClass("waiting"),p.off("mouseout").addClass("active"),$("#main article").off("mouseout"),$(".video").velocity("stop").velocity({opacity:.5},{duration:settings.animationSpeed}),f.addClass("off"),$(".test-title").text(p.data("title")),w=!1,x.pause(),b.off("mousewheel"),settings.isMobile?a():setTimeout(function(){a()},2e3)}function a(){$("header.over-main").css("height","100%"),$("header.over-main").velocity("stop").velocity({height:0},{duration:2*settings.animationSpeed,complete:function(){$(".overlay").hide(),$("#main").remove()}}),$("#main").velocity("stop").velocity({translateY:"-100%"},{duration:2*settings.animationSpeed})}function l(t,e){var o=Math.round(t);console.log(o);for(var i=0;i<S.length;i++)o==S[i].time&&(p.attr("href",S[i].url),p.attr("data-title",S[i].title))}function d(){return settings.isMobile?!1:(console.log("clear theater timer"),void(m?r():(clearTimeout(v),v=setTimeout(c,5e3))))}function c(){console.log("theater mode on "),m=!0,$("body").addClass("theaterMode"),$(".video").velocity("stop").velocity({opacity:1},{duration:settings.animationSpeed}),$(".project").velocity("stop").velocity({opacity:0},{duration:settings.animationSpeed})}function r(){console.log("theater mode off"),m=!1,$("body").removeClass("theaterMode"),$(".video").velocity("stop").velocity({opacity:.5},{duration:settings.animationSpeed}),$(".project").velocity("stop").velocity({opacity:1},{duration:settings.animationSpeed})}function u(){console.log("resize"),b.width()<768?(c(),h(),settings.isMobile=!0):(d(),settings.isMobile=!1),h()}function h(){if(settings.isMobile)if(T)b.width()<b.height()?$(".videoMobile canvas").attr("width",.6666*b.height()).attr("height",b.height()):$(".videoMobile canvas").attr("width",b.width()).attr("height",1.5*b.width());else{console.log("LOAD MOBILE VID"),T=!0;var t=canvid({selector:".videoMobile",videos:{clip1:{src:"assets/video/myvideo.jpg",frames:194,fps:30,cols:10,loops:1,onEnd:function(){console.log("clip1 ended."),t.play("clip1")}}},width:.6666*b.height(),height:b.height(),loaded:function(){t.play("clip1")}})}}var v,m,g=$(t),p=$("aside .button--primary"),f=$(".volume-toggle"),y=f.find(".mode"),b=$(window),M=$("#videoMobile"),w=!0,C=g.data("vide"),S=[],j=0,x=C.getVideoObject(),T=!1;b.on("mousewheel",function(t){j+=t.deltaY,j<=-b.height()?w&&(w=!1,x.pause()):w||(w=!0,x.play())}).on("mousemove",throttle(d,300)).on("resize",throttle(u,300)),b.on("mousewheel",throttle(d,300)),e()};
},{"canvid":1,"modules/settings":"modules/settings","modules/throttle":"modules/throttle"}]},{},[5])
